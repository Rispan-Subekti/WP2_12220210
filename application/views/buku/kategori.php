...
</td><td> <a href="<?= base_url('buku/hapusKategori/') . $k['id']; ?>" onclick="return
...
<!-- <input type="text" name="kategori" id="kategori" placeholder="Masukkan Nama
...
<button type="button" class="btn btn-secondary" data-dismiss="modal"><i class="fas fa-
ban"></i> Close</button>
